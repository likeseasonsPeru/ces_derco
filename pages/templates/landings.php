...
if ($tipo_usuario == "Administrador") {
	...
	$textoSelectMarcas = 'Seleccione una Marca';
	...
	// Marcas
	foreach ($marcaArray as $marca => $key) {
		$html_code_marcas .= '<li class="navi-item">';
		$html_code_marcas .= '<a href="javascript:void(0);" onclick="updateMarca('. $marcaArray[$marca] .')" class="navi-link">'; // llamar al JS de tienda
		$html_code_marcas .= '<span class="navi-text">'.$marca.'</span>';
		$html_code_marcas .= '</a>';
		$html_code_marcas .= '</li>';
	}
			...
			<div class="card-header flex-wrap border-0 pt-6 pb-0">
				...
				<div class="card-toolbar">
					...
					<div class="dropdown dropdown-inline mr-2">
						...
						<!--begin::Dropdown Menu-->
						<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right" style="width:100%;     transform: translate3d(5px, 39px, 0px);">
							<!--begin::Navigation-->
					...
					<?php if ($section_title == 'Catálogo DERCO' || $section_title == 'CyberGO' || $section_title == 'DERCO Outlet') { ?>
						<div class="dropdown dropdown-inline mr-2">
							<button type="button" class="btn btn-light-primary font-weight-bolder dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<span class="svg-icon svg-icon-md">
									<svg xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
